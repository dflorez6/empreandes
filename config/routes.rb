ANEU::Application.routes.draw do
  ...
  match "/register" => "statics#register"
  match "/new" => "statics#new"
  match "auth/facebook/callback" => "statics#create"
  match "/salir" => "statics#salir"
  get "/activation" => "statics#activation"
  post "/activation" => "statics#activation"
